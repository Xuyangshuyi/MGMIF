...
class BaseCfgs(PATH):
    def __init__(self):
        ...
        # BERT PRETRAINED_HIDDEN_SIZE
        self.PRETRAINED_HIDDEN = 768
        ...
        # An external method to set train split
        ...
        self.FEAT_SIZE = {
            ...
            'vqa_grid': {
                'FRCN_FEAT_SIZE': (64, 2048), # 8*8=64
                'BBOX_FEAT_SIZE': (100, 5),
            },
            'vqa_grid16': {
                'FRCN_FEAT_SIZE': (256, 2048), # 16*16=256
                'BBOX_FEAT_SIZE': (100, 5),
            },
        }

        # Set if bbox_feat need be normalized by image size, default: False
        ...
        # Large model can not train with batch size 64
